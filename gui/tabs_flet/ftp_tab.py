...
class FTPTab:
    ...
    def build(self):
        ...
        self.btn_ftp = ft.Button(content=ft.Text("Start FTP"), on_click=self.toggle_ftp)
        self.btn_sftp = ft.Button(content=ft.Text("Start SFTP"), on_click=self.toggle_sftp)
    ...
    def toggle_ftp(self, e):
        ...
        if self.ftp_running:
            ...
            self.btn_ftp.style = ft.ButtonStyle(bgcolor=ft.Colors.ERROR)
            ...
            self.btn_ftp.style = ft.ButtonStyle(bgcolor=ft.Colors.PRIMARY)
    ...
    def toggle_sftp(self, e):
        ...
        if self.sftp_running:
            ...
            self.btn_sftp.style = ft.ButtonStyle(bgcolor=ft.Colors.ERROR)
            ...
            self.btn_sftp.style = ft.ButtonStyle(bgcolor=ft.Colors.PRIMARY)
